...
gen_algo_sparse_long$fit$control$index <- NULL
gen_algo_sparse_long$fit$control$indexOut <- NULL
gen_algo_sparse_long$fit$finalModel$x <- NULL
gen_algo_sparse_long$ga$fit$trainingData <- NULL
gen_algo_sparse_long$ga$fit$control$index <- NULL
gen_algo_sparse_long$ga$fit$control$indexOut <- NULL
gen_algo_sparse_long$ga$fit$finalModel$x <- NULL
gen_algo_sparse_long$control$index <- NULL
gen_algo_sparse_long$control$indexOut <- NULL
gen_algo_sparse_long$recipe$template <- NULL
attr(gen_algo_sparse_long$recipe$steps[[2]]$terms[[1]], ".Environment") <- emptyenv()

# ------------------------------------------------------------------------------

save(gen_algo_sparse_long, file = "gen_algo_sparse_long.RData")
